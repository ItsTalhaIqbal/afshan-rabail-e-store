...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Afshan Rabail | Modest Abayas & Burkhas in Pakistan" },
      { property: "og:description", content: "Shop premium modest abayas, burkhas, and festive wear at Afshan Rabail. Quality fabrics, Cash on Delivery, nationwide shipping across Pakistan." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Afshan Rabail | Modest Abayas & Burkhas in Pakistan" },
      { name: "twitter:description", content: "Shop premium modest abayas, burkhas, and festive wear at Afshan Rabail. Quality fabrics, Cash on Delivery, nationwide shipping across Pakistan." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1126b1ed-f3f4-4198-81cf-b99a0fc6f03a/id-preview-300dccd8--42bd61ef-43fd-481e-822d-1a313ed969ab.lovable.app-1779243709463.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1126b1ed-f3f4-4198-81cf-b99a0fc6f03a/id-preview-300dccd8--42bd61ef-43fd-481e-822d-1a313ed969ab.lovable.app-1779243709463.png" },
    ],
    links: [
